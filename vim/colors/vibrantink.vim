...
if has("gui_running")
    ...
    highlight Cunsor guifg=Black   guibg=Yellow
    highlight Keyword guifg=#009DB5
    highlight Define guifg=#FF6600
    highlight Comment guifg=#9933CC
    highlight Type guifg=White gui=NONE
    highlight rubySymbol guifg=#339999 gui=NONE
    highlight Identifier guifg=#FF6600 gui=NONE
    ...
    highlight Search guifg=White guibg=#2e2e2e
    highlight CursorLine guibg=#323300
    highlight Visual guibg=#2e2e2e
else
    set t_Co=256
